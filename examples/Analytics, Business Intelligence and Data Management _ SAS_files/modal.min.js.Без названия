...
jQuery.fn.handleModal=function(a,b,c){jQuery("#"+b).load(c,function(){jQuery("#"+b+" video").each(function(){var i;
var e=jQuery(this);
var g=e.attr("id");
var h=e.attr("data-track-position");
var f=e.clone().wrap("<p>").parent().html();
e.remove();
function j(){var k=setInterval(function(){if(jQuery("#"+a).is(":visible")&&typeof bc!=="undefined"){clearInterval(k);
jQuery("#"+b+" div.brightcove-container").prepend(f);
bc(document.getElementById(g));
i=videojs(g);
if(h>0){videojs(g).ready(function(){var l=this;
l.on("play",function(){l.textTracks()[h].mode="showing"
})
})
}}},500)
}j();
jQuery(document).on("hide.bs.modal","#"+a,function(){try{i.dispose()
}catch(k){}j()
})
})
});
